...
const pageConfig: PageConfig = {
  ...
  title: "2507 LearningHub Status",
  // Links shown at the header of your status page, could set `highlight` to `true`
  links: [
    { link: 'https://www.hzaucoi2507.xyz/', label: '2507 LearningHub' },
    { link: 'https://blog.lcyteam.me/', label: 'LCY Blog' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    {
      id: '2507learninghub',
      name: '2507 LearningHub',
      method: 'HEAD',
      target: 'https://www.hzaucoi2507.xyz/',
      statusPageLink: 'https://www.hzaucoi2507.xyz/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    ...
    },
    {
      ...
      method: 'HEAD',
      target: 'https://learning.hzaucoi2507.xyz/',
      statusPageLink: 'https://learning.hzaucoi2507.xyz/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      id: '2507learninghubbackup2',
      name: '2507 LearningHub 备用地址 2',
      method: 'HEAD',
      target: 'https://learning.lcyteam.me/',
      statusPageLink: 'https://learning.lcyteam.me/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    }
  ...
  notification: {
    ...
    webhook: {
      ...
      payload: {
        "from": "2507 LearningHub Status 状态更新 <hubstatus@hzaucoi2507.xyz>",
        "to": ["cjg2772@163.com"],
        "subject": "2507 LearningHub Status 状态更新",
        "text": "$MSG"
      },
